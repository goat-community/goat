...
SELECT st_intersection (c.geom, b.geom) AS geom, b.ags, b.gid, ST_Area(b.geom::geography) area_complete
...
(	SELECT gid, geom 
	FROM landuse 
	WHERE objart IN ('41005', '41002', '41009','41007','41008')
...
(
	...
	WHERE landuse in('farmyard','quarry','industrial','retail','commercial','military','cemetery','landfill','allotments','recreation ground','railway')
	OR tourism ='zoo'
	OR amenity='hospital'
...
UPDATE buildings_residential_fusion
SET building_levels_residential = 2
...
(
	...
	(b.area*building_levels_residential)/60 AS new_residents
...
substract_exceed_pop AS (
	...
	AND census.pop = -1 
	AND census.number_buildings_now > 2
),
remaining_pop AS (
