...
concaveman = cppimport.imp("app.exts.concaveman.cpp.concaveman")
...
def concaveman2d(points, hull, concavity=2.0, lengthThreshold=0.0):
    ...
    concave_points = concaveman.concaveman(points, hull, concavity, lengthThreshold)

    return concave_points


if __name__ == "__main__":
    print(concaveman2d([[0, 0], [0.25, 0.15], [1, 0], [1, 1]], [0, 2, 3]))
