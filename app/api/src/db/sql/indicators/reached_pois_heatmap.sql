...
CREATE OR REPLACE FUNCTION basic.reached_pois_heatmap(table_name TEXT, calculation_geom geometry, user_id_input integer, scenario_id_input integer DEFAULT 0, data_upload_ids integer[] DEFAULT '{}'::integer[])
RETURNS VOID
AS $function$
DECLARE
...
/*
EXPLAIN ANALYZE 
SELECT basic.reached_pois_heatmap('poi_user', s.geom, 4, 0, ARRAY[75]) 
