CREATE OR REPLACE FUNCTION basic.get_population_multi_sum(user_id_input integer, modus text, extent geometry, pixel_resolution integer, scenario_id_input integer DEFAULT 0)
...
/*
SELECT * 
FROM basic.get_population_multi_sum(15, 'default'::text, ST_SETSRID(ST_BUFFER(ST_MAKEPOINT(11.57616,48.13168)::geography, 200000)::geometry, 4326), 10) 
*/
