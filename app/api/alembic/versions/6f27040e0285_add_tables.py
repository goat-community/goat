...
Revision ID: 6f27040e0285
Revises: 96e8ab19a2ae
Create Date: 2022-01-23 11:21:05.007341
...
revision = '6f27040e0285'
down_revision = '96e8ab19a2ae'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_basic_grid_calculation_grid_visualization_id'), 'grid_calculation', ['grid_visualization_id'], unique=False, schema='basic')
    ...
    op.create_index(op.f('ix_basic_study_area_grid_visualization_grid_visualization_id'), 'study_area_grid_visualization', ['grid_visualization_id'], unique=False, schema='basic')
    ...
    sa.Column('default_setting', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('upload_grid_ids', sa.ARRAY(sa.Text()), nullable=False),
    ...
    sa.Column('deleted_pois', sa.ARRAY(sa.Integer()), server_default=sa.text("'{}'::int[]"), nullable=True),
    ...
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    sa.ForeignKeyConstraint(['aoi_id'], ['basic.aoi.id'], ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_basic_aoi_scenario_id'), 'aoi', ['scenario_id'], unique=False, schema='basic')
    ...
    op.create_index(op.f('ix_basic_poi_scenario_id'), 'poi', ['scenario_id'], unique=False, schema='basic')
    op.create_table('aoi_user',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('data_upload_id', sa.Integer(), nullable=False),
    sa.Column('scenario_id', sa.Integer(), nullable=True),
    sa.Column('aoi_user_id', sa.Integer(), nullable=True),
    sa.Column('category', sa.Text(), nullable=False),
    sa.Column('name', sa.Text(), nullable=True),
    sa.Column('opening_hours', sa.Text(), nullable=True),
    sa.Column('wheelchair', sa.Text(), nullable=True),
    ...
    sa.Column('creation_date', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['customer.user.id'], ondelete='CASCADE'),
    ...
    sa.Column('data_upload_id', sa.Integer(), nullable=False),
    sa.Column('scenario_id', sa.Integer(), nullable=True),
    sa.Column('poi_user_id', sa.Integer(), nullable=True),
    sa.Column('category', sa.Text(), nullable=False),
    sa.Column('name', sa.Text(), nullable=True),
    sa.Column('street', sa.Text(), nullable=True),
    sa.Column('housenumber', sa.Text(), nullable=True),
    ...
    sa.Column('geom_3857', geoalchemy2.types.Geometry(geometry_type='LINESTRING', srid=3857, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    ...
    sa.Column('demography', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    ...
    op.create_index(op.f('ix_basic_population_scenario_id'), 'population', ['scenario_id'], unique=False, schema='basic')
    ...
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    sa.Column('creation_date', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['basic.aoi.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['scenario_id'], ['customer.scenario.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='customer'
    )
    ...
    sa.Column('reached_opportunities', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    ...
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    sa.Column('creation_date', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['basic.poi.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['poi_user_id'], ['customer.poi_user.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['scenario_id'], ['customer.scenario.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='customer'
    )
    op.create_index('idx_poi_modified_geom', 'poi_modified', ['geom'], unique=False, schema='customer', postgresql_using='gist')
    op.create_index(op.f('ix_customer_poi_modified_poi_id'), 'poi_modified', ['poi_id'], unique=False, schema='customer')
    op.create_index(op.f('ix_customer_poi_modified_poi_user_id'), 'poi_modified', ['poi_user_id'], unique=False, schema='customer')
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('edge_id', sa.Integer(), nullable=True),
    sa.Column('isochrone_calculation_id', sa.Integer(), nullable=True),
    sa.Column('cost', sa.Float(precision=53), nullable=True),
    sa.Column('start_cost', sa.Float(precision=53), nullable=True),
    sa.Column('end_cost', sa.Float(precision=53), nullable=True),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_customer_poi_modified_poi_user_id'), table_name='poi_modified', schema='customer')
    op.drop_index(op.f('ix_customer_poi_modified_poi_id'), table_name='poi_modified', schema='customer')
    ...
    op.drop_index(op.f('ix_basic_population_scenario_id'), table_name='population', schema='basic')
    ...
    op.drop_index(op.f('ix_basic_poi_scenario_id'), table_name='poi', schema='basic')
    ...
    op.drop_index(op.f('ix_basic_aoi_scenario_id'), table_name='aoi', schema='basic')
    ...
    op.drop_index(op.f('ix_basic_study_area_grid_visualization_grid_visualization_id'), table_name='study_area_grid_visualization', schema='basic')
    op.drop_table('study_area_grid_visualization', schema='basic')
    op.drop_table('grid_visualization_parameter', schema='basic')
    op.drop_index(op.f('ix_basic_grid_calculation_grid_visualization_id'), table_name='grid_calculation', schema='basic')
