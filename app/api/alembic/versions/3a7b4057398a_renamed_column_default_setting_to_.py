...
def upgrade():
    ...
    op.add_column('customization', sa.Column('setting', postgresql.JSONB(astext_type=sa.Text()), nullable=True), schema='customer')
    op.drop_column('customization', 'default_setting', schema='customer')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('customization', sa.Column('default_setting', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False), schema='customer')
    op.drop_column('customization', 'setting', schema='customer')
