...
Revision ID: ef6d9681f09d
Revises: 
Create Date: 2022-02-12 10:13:29.690722
...
def upgrade():
    ...
    op.create_index(op.f('ix_customer_user_role_role_id'), 'user_role', ['role_id'], unique=False, schema='customer')
    op.create_index(op.f('ix_customer_user_role_user_id'), 'user_role', ['user_id'], unique=False, schema='customer')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_customer_user_role_user_id'), table_name='user_role', schema='customer')
    op.drop_index(op.f('ix_customer_user_role_role_id'), table_name='user_role', schema='customer')
