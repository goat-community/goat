import AccessSettings from "@/app/[lng]/(dashboard)/content/AccessSettings";
...
const ShareModal = (props: ShareModalProps) => {
  ...
  const [, setPassword] = useState<string | null>(null);
    ...
    <div>
      {modalView === 0 ? (
        <div>
          ...
          <div className={classes.switcher}>
            <Switch checked={checkedExpirationDate} onChecked={handleExpirationStatus} />
            <Text typo="body 1">Expiration date</Text>
          </div>
