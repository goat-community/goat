import ngeoPrintVectorEncoder from "./VectorEncoder.js";
 ...
 * @hidden
 */
function createPrintServiceFactory(gettextCatalog, ngeoLayerHelper) {
  return (
    /**
     ...
     */
    function(url) {
      return new PrintService(url, gettextCatalog, ngeoLayerHelper);
    }
  );
}
