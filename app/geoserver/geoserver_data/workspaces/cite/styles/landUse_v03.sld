  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>Facilities</se:Name>
          <se:Description>
            <se:Title>Facilities</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>landuse</ogc:PropertyName>
              <ogc:Literal>facilities</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>protected_soil</se:Name>
          <se:Description>
            <se:Title>protected_soil</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>landuse</ogc:PropertyName>
              <ogc:Literal>protected_soil</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>Parks and public space</se:Name>
          <se:Description>
            <se:Title>Parks and public space</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#cab2d6</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#232323</se:SvgParameter>
              <se:SvgParameter name="stroke-opacity">0</se:SvgParameter>
