...
sensitivities = [350000,550000,750000,800000,900000,950000,1000000]
...
while lower_limit < count_grids:
    ...
    sql_bulk_calculation = '''
    	...
    	(
    		...
    		SELECT precalculate_grid(1,'%s',20, x.array_starting_points,5,x.grid_ids,1,'walking_standard') 
    		FROM x;'''
