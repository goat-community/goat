...
ALTER TABLE impedance_table ADD COLUMN IF NOT EXISTS impedance_walking numeric;
ALTER TABLE impedance_table ADD COLUMN IF NOT EXISTS impedance_cycling numeric;
ALTER TABLE impedance_table ADD COLUMN IF NOT EXISTS impedance_wheelchair numeric;
ALTER TABLE impedance_table ADD COLUMN IF NOT EXISTS impedance_total numeric;

update impedance_table set impedance_walking = coalesce(impedance_was,0)+ coalesce(impedance_wac,0);
update impedance_table set impedance_cycling = coalesce(impedance_cys,0)+ coalesce(impedance_cyc,0);
update impedance_table set impedance_wheelchair = coalesce(impedance_whs,0)+ coalesce(impedance_whc,0);
update impedance_table set impedance_total = coalesce(impedance_walking,0)+coalesce(impedance_cycling,0)+coalesce(impedance_wheelchair,0);
