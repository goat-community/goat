...
DROP FUNCTION IF EXISTS query_ways_routing;
CREATE OR REPLACE FUNCTION public.query_ways_routing(buffer_geom text, modus_input integer, scenario_id_input integer, speed_input float, routing_profile text)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
DECLARE 
...
$function$;
/*
SELECT query_ways_routing(ST_ASTEXT(ST_BUFFER(ST_POINT(11.543274,48.195524),0.0018)),1,1,1.33,'walking_standard')
*/