...
BEGIN
	...
	VALUES(NEW.name, NEW.amenity, NEW.opening_hours,NEW.geom,NEW.userid,NEW.wheelchair,NEW.id);
																   --0.01126126
	influenced_cells = GetCellsInfluencedByGeometry(ARRAY[NEW.geom], 0.01);	
	points_array = (SELECT array_agg(ARRAY[ST_X(st_centroid(geom))::numeric,ST_Y(ST_Centroid(geom))::numeric] ORDER BY grid_id) FROM grid_500 WHERE grid_id IN (SELECT unnest(influenced_cells)));
	RAISE NOTICE 'points_array: %', points_array;
	RAISE NOTICE 'influenced_cells: %', influenced_cells;

	PERFORM precalculate_grid(NEW.userid, 'grid_500'::TEXT, 10, points_array, 2::NUMERIC, influenced_cells, 1, 'walking_standard'::TEXT);
	RETURN NEW; 
END;
...
SELECT precalculate_grid(100, 'grid_500'::TEXT, 10, ARRAY[[11.2159648872149,48.1966022942256],[11.2159648872149,48.1876195666537],[11.2198545923951,48.1921111272717],[11.2140200346248,48.1988477300806],[11.2159648872149,48.1921111272717],[11.217909739805,48.1988477300806],[11.2081854768544,48.1921111272717],[11.217909739805,48.1943567599562],[11.2081854768544,48.1966022942256],[11.2198545923951,48.1966022942256],[11.2159648872149,48.2010930675222],[11.2120751820347,48.1876195666537],[11.2101303294446,48.1943567599562],[11.2120751820347,48.1921111272717],[11.2120751820347,48.1966022942256],[11.2062406242643,48.1943567599562],[11.2140200346248,48.1943567599562],[11.2101303294446,48.1988477300806],[11.2101303294446,48.1898653961712],[11.2140200346248,48.1898653961712],[11.217909739805,48.1898653961712]],                  2::NUMERIC, ARRAY[7,10,36,43,63,99,126,205,233,249,262,271,281,289,298,304,322,356,387,466,479], 1, 'walking_standard'::TEXT);
