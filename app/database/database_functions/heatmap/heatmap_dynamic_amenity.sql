DROP FUNCTION IF EXISTS heatmap_dynamic_amenity;
CREATE OR REPLACE FUNCTION public.heatmap_dynamic_amenity(amenities_json jsonb, modus_input text DEFAULT 'default', scenario_id_input integer DEFAULT 0)
 RETURNS TABLE(grid_id integer, amenity_name text, accessibility_index bigint)
 LANGUAGE plpgsql
AS $function$
DECLARE
