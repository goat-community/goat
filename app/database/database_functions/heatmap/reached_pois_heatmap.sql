...
CREATE OR REPLACE FUNCTION public.reached_pois_heatmap(buffer_geom geometry, snap_distance NUMERIC, combination_scenarios smallint DEFAULT 0, userid_input integer DEFAULT 0, scenario_id_input integer DEFAULT 0)
RETURNS VOID
AS $function$
DECLARE
...
SELECT * FROM pois_userinput WHERE userid IS IN(NULL) 
