...
RETURNS TABLE (osm_id bigint, highway text, "parking:lane:both" text, "parking:lane:left" text,
    "parking:lane:right" text, geom geometry) AS
$$
    SELECT w.osm_id, w.highway, "parking:lane:both", "parking:lane:left", "parking:lane:right", w.geom
...
IS '**FOR-API-FUNCTION** RETURNS col_names[osm_id,highway,"parking:lane:both","parking:lane:left","parking:lane:right",geom] **FOR-API-FUNCTION**';