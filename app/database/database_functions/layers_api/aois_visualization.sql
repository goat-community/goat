...
CREATE OR REPLACE FUNCTION public.aois_visualization(userid_input INTEGER, aois_input TEXT[])
...
COMMENT ON FUNCTION aois_visualization(userid_input INTEGER, aois_input TEXT[]) 
