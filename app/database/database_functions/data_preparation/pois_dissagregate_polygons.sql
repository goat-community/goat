...
CREATE OR REPLACE FUNCTION pois_dissagregate_polygons(subset TEXT, myamenity TEXT)
	RETURNS void
	LANGUAGE plpgsql
AS $function$
BEGIN 
	...
	CREATE TABLE access_points (LIKE planet_osm_polygon INCLUDING all);	
	...
	CREATE TABLE no_of_intersections(LIKE no_of_doors INCLUDING all);
