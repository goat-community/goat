...
Furthermore, knowledge about the user backgrounds can guide us in advancing GOAT in the most useful direction. For this purpose, we will ask some user-related questions, for example about the profession. At the end of the survey, the participants can rate GOAT and name features that they would like to see in GOAT in the future.
